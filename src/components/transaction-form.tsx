  ...
  const FormSchema = z
    ...
    .refine(
      (data) => {
        ...
        return sourceAccount ? sourceAccount.balance >= data.amount : false;
      },
      {
        ...
        {hasEnoughAccounts ? (
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
              ...
              />
              <Button className="w-full" type="submit" disabled={form.formState.isSubmitting || !hasEnoughAccounts}>
                {form.formState.isSubmitting ? 'Transferring...' : 'Transfer Funds'}
